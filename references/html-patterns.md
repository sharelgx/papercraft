...
Core components: title slide, section divider, two-column argument slide, metric/chart slide, quote slide, timeline/roadmap slide, closing slide.

Example from this skill: `examples/presentation.html` — bilingual deck viewer with thumbnails, speaker notes, keyboard navigation, fullscreen mode, and reusable slide components.
