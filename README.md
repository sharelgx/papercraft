...
| `examples/presentation.html` | PPT-style deck viewer — adaptive 16:9 stage, thumbnails, title/two-column/data/logic-map/chart/report/table/mixed-media/code/quote/timeline components, keyboard navigation, presenter notes, fullscreen |
