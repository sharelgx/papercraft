...
| `examples/presentation.html` | PPT-style deck viewer — 16:9 slides, thumbnails, title/two-column/data/quote/timeline components, keyboard navigation, presenter notes, fullscreen |
