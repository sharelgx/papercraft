...
3. **`examples/`** — Runnable HTML demos as visual anchors. Read the closest match before generating:
   ...
   - `examples/presentation.html` — PPT-style deck: 16:9 slides, thumbnails, keyboard navigation, presenter notes, fullscreen. *(EN/ZH)*
...
- **PPT / presentation:** one claim per slide. Use 16:9 canvas, slide thumbnails, presenter notes, clear page numbers, and keyboard navigation when building HTML decks. For actual PPTX work, translate the same components into title, section, two-column, metric/chart, quote, timeline, and closing slides.
